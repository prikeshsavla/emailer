...
class EmailTemplatesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @email_template.save
        format.html do
          redirect_to email_template_url(@email_template), notice: t('messages.email_template.created_successfully')
        end
  ...
  def update
    respond_to do |format|
      if @email_template.update(email_template_params)
        format.html do
          redirect_to email_template_url(@email_template), notice: t('messages.email_template.updated_successfully')
        end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to email_templates_url, notice: t('messages.email_template.deleted_successfully') }
  ...
  def email_template_params
    params.require(:email_template).permit(:name, :label, :body, :subject, :custom_fields)
  end
end
